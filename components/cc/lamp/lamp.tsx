	...
	return (
		...
		>
			<div className='relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center '>
				...
				<div className='absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-foreground blur-2xl' />
				...
				<div className='absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-foreground ' />
			</div>
